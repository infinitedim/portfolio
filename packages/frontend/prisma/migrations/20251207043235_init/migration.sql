...
-- CreateIndex
CREATE UNIQUE INDEX "admin_profiles_adminUserId_key" ON "admin_profiles"("adminUserId");

-- CreateIndex
CREATE INDEX "allowed_ips_ipAddress_idx" ON "allowed_ips"("ipAddress");

-- CreateIndex
CREATE INDEX "allowed_ips_isActive_idx" ON "allowed_ips"("isActive");

-- CreateIndex
CREATE INDEX "allowed_ips_adminUserId_idx" ON "allowed_ips"("adminUserId");

-- CreateIndex
CREATE UNIQUE INDEX "allowed_ips_adminUserId_ipAddress_key" ON "allowed_ips"("adminUserId", "ipAddress");
...
-- CreateIndex
CREATE INDEX "blog_posts_published_viewCount_idx" ON "blog_posts"("published", "viewCount" DESC);
...
-- CreateIndex
CREATE INDEX "projects_viewCount_idx" ON "projects"("viewCount" DESC);

-- CreateIndex
CREATE INDEX "projects_featured_status_idx" ON "projects"("featured", "status");
...
-- AddForeignKey
ALTER TABLE "admin_profiles" ADD CONSTRAINT "admin_profiles_adminUserId_fkey" FOREIGN KEY ("adminUserId") REFERENCES "admin_users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "allowed_ips" ADD CONSTRAINT "allowed_ips_adminUserId_fkey" FOREIGN KEY ("adminUserId") REFERENCES "admin_users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
