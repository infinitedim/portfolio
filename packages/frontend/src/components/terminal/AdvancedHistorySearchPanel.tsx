...
} from "@portfolio/frontend/src/hooks/useAdvancedCommandHistory";

interface AdvancedHistorySearchPanelProps {
  isOpen: boolean;
  onClose: () => void;
...
/**
 * Enhanced command history search panel with advanced filtering, favorites, and analytics
 */
export function AdvancedHistorySearchPanel({
  isOpen,
  onClose,
  onSelectCommand,
  className = "",
}: AdvancedHistorySearchPanelProps): JSX.Element | null {
