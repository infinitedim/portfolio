...
interface UseAdvancedCommandHistoryOptions {
...
/**
 * Advanced command history hook with search, analytics, and smart categorization
 */
export function useAdvancedCommandHistory({
  maxHistorySize = 500,
  persistKey = "advanced-terminal-history",
  enableAnalytics = true,
  autoCategories = true,
}: UseAdvancedCommandHistoryOptions = {}) {
