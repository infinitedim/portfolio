...
//   adminEmail;
//   adminPasswordHash;
//   constructor(securityService, auditLogService) {
...
//     }
//   }
//   async validateCredentials(email, password, clientIp, request) {
//     // Validate input
...
//   }
//   async refreshToken(refreshToken, clientIp, request) {
//     try {
...
//     }
//   }
//   async logout(token, clientIp, request) {
//     try {
